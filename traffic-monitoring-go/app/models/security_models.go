...
type SecurityEvent struct {
	...
	SourceIP        string        `gorm:"index:idx_source_ip" json:"source_ip"`
	...
	LogSourceID     uint          `gorm:"index:idx_log_source" json:"log_source_id"`
	LogSource       LogSource     `gorm:"foreignKey:LogSourceID" json:"log_source"`
	Severity        EventSeverity `gorm:"not null;index:idx_severity_severity" json:"severity"`
	Category        EventCategory `gorm:"not null;index:idx_category" json:"category"`
