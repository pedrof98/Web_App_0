...
type BasicSafetyMessage struct {
	ID           uint       `gorm:"primaryKey" json:"id"`
	V2XMessageID uint       `gorm:"not null;column:v2_x_message_id" json:"v2x_message_id"`
	V2XMessage   V2XMessage `gorm:"foreignKey:V2XMessageID;references:ID" json:"v2x_message"`
...
type V2XSecurityInfo struct {
	ID              uint       `gorm:"primaryKey" json:"id"`
	V2XMessageID    uint       `gorm:"not null;uniqueIndex;column:v2_x_message_id" json:"v2x_message_id"`
	V2XMessage      V2XMessage `gorm:"foreignKey:V2XMessageID;references:ID" json:"v2x_message"`
